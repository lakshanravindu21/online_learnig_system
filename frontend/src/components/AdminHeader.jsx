    ...
    <header className="bg-white border-b border-gray-200 px-4 sm:px-6 lg:px-8 py-4">
      <div className="flex items-center justify-between flex-nowrap gap-2">
        ...
        <div className="flex items-center gap-2 min-w-0 flex-shrink-0">
          ...
          {/* Dashboard Title */}
          <h1 className="text-xl font-semibold text-gray-900 ml-4 sm:ml-8 truncate">
            Dashboard
          </h1>
        </div>
        ...
        <div className="flex items-center gap-2 sm:gap-4 flex-shrink-0 min-w-0">
          {/* Search */}
          <div className="hidden md:flex items-center flex-shrink min-w-[120px] max-w-[250px]">
          ...
          <div className="flex items-center gap-2 flex-shrink-0">
            ...
            <span className="text-sm font-medium text-gray-700 hidden md:block truncate">Admin</span>
          </div>
        </div>
      </div>
